            ...
            <div class="row">
                ...
                <aside class="col-md-4 widget widget_contact_info">
                    ...
                    <ul class="sportsmagazine-social-network">
                        <li>
                            <a href="https://www.facebook.com/" class="sportsmagazine-colorhover fa fa-facebook-official"></a>
                        </li>
                        <li>
                            <a href="https://twitter.com/login" class="sportsmagazine-colorhover fa fa-twitter-square"></a>
                        </li>
                        <li>
                            <a href="https://pk.linkedin.com/" class="sportsmagazine-colorhover fa fa-linkedin-square"></a>
                        </li>
                        <li>
                            <a href="https://plus.google.com/" class="sportsmagazine-colorhover fa fa-google-plus-square"></a>
                        </li>
                    </ul>
                ...
                <aside class="col-md-4 widget widget_gallery">
                    ...
                    <ul>
                        <li>
                            <a data-fancybox-group="group" href="{{url('assets/extra-images/widget-gallery-1.jpg')}}" class="fancybox"><img src="{{url('assets/extra-images/widget-gallery-1.jpg')}}" alt=""></a>
                        </li>
                        <li>
                            <a data-fancybox-group="group" href="{{url('assets/extra-images/widget-gallery-1.jpg')}}" class="fancybox"><img src="{{url('assets/extra-images/widget-gallery-2.jpg')}}" alt=""></a>
                        </li>
                        <li>
                            <a data-fancybox-group="group" href="{{url('assets/extra-images/widget-gallery-1.jpg')}}" class="fancybox"><img src="{{url('assets/extra-images/widget-gallery-3.jpg')}}" alt=""></a>
                        </li>
                        <li>
                            <a data-fancybox-group="group" href="{{url('assets/extra-images/widget-gallery-1.jpg')}}" class="fancybox"><img src="{{url('assets/extra-images/widget-gallery-4.jpg')}}" alt=""></a>
                        </li>
                        <li>
                            <a data-fancybox-group="group" href="{{url('assets/extra-images/widget-gallery-1.jpg')}}" class="fancybox"><img src="{{url('assets/extra-images/widget-gallery-5.jpg')}}" alt=""></a>
                        </li>
                        <li>
                            <a data-fancybox-group="group" href="{{url('assets/extra-images/widget-gallery-1.jpg')}}" class="fancybox"><img src="{{url('assets/extra-images/widget-gallery-6.jpg')}}" alt=""></a>
                        </li>
                        <li>
                            <a data-fancybox-group="group" href="{{url('assets/extra-images/widget-gallery-1.jpg')}}" class="fancybox"><img src="{{url('assets/extra-images/widget-gallery-7.jpg')}}" alt=""></a>
                        </li>
                        <li>
                            <a data-fancybox-group="group" href="{{url('assets/extra-images/widget-gallery-1.jpg')}}" class="fancybox"><img src="{{url('assets/extra-images/widget-gallery-8.jpg')}}" alt=""></a>
                        </li>
                    </ul>
                </aside>
                <!--// Widget Gallery \\-->
        ...
        <div class="container">
            <div class="row">
                <aside class="col-md-6 sportsmagazine-copyright-left">
                    <p>© 2016, Matchtimings All Right Reserved - by <a href="https://progmattic.com" target="_blank">progmattic.com</a></p>
                </aside>
